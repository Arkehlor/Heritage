/// @function mp_grid_astar2(grid, cost, path, x_start, y_start, x_goal, y_goal, xstart, ystart, hcells, vcells, cellwidth, cellheight);
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        {          
			...
			for (var i3 = ds_list_size(list_path) - 1; i3 >= 0; i3--)
			{
				if (found)
				{
					if (ds_list_find_value(ds_list_find_value(list_path, i3), 3) > 50)
					{
						found = false;
